...
and retrieval. Supports S3, SharePoint, Confluence, Google Drive, OneDrive,
and web content as sources.

Replace KNOWLEDGE_BASE_ID in .env with your KB ID.
"""
...
def retrieve(query: str, top_k: int = 5) -> list[dict]:
    ...
    if not KNOWLEDGE_BASE_ID:
        logger.warning("KNOWLEDGE_BASE_ID not set — returning stub results")
    ...
    try:
        ...
        logger.error("bedrock_kb retrieve failed: %s", exc)
        return []
